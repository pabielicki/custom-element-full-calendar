...
var author$project$Main$CalendarDateSelected = function (a) {
	return {$: 'CalendarDateSelected', a: a};
};
var elm$time$Time$posixToMillis = function (_n0) {
	var millis = _n0.a;
	return millis;
};
var author$project$Main$allDayEndTime = F2(
	function (time, allDay) {
		if (allDay) {
			return (((1000 * 60) * 60) * 24) + elm$time$Time$posixToMillis(time);
		} else {
...
var author$project$Main$encodeEvent = function (_n0) {
	var messageId = _n0.a;
	var textContent = _n0.b;
	var event = _n0.c;
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'title',
				elm$json$Json$Encode$string(textContent)),
				_Utils_Tuple2(
				'start',
				elm$json$Json$Encode$int(
					elm$time$Time$posixToMillis(event.startTime))),
				_Utils_Tuple2(
				'end',
				elm$json$Json$Encode$int(
					A2(author$project$Main$allDayEndTime, event.endTime, event.allDay))),
				_Utils_Tuple2(
				'allDay',
				elm$json$Json$Encode$bool(event.allDay)),
				_Utils_Tuple2(
				'id',
				elm$json$Json$Encode$string(messageId))
			]));
};
...
var author$project$Main$encodeEvents = F2(
	function (id, events) {
		return elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'events',
					A2(elm$json$Json$Encode$list, author$project$Main$encodeEvent, events))
				]));
	});
			...
			[
				...
				_List_fromArray(
					[
						...
						'calendarEvents',
						A2(author$project$Main$encodeEvents, '0', events)),
						A2(
						elm$html$Html$Attributes$property,
						'calendar-timeZone',
						...
						A2(
							...
							author$project$Main$CalendarDateSelected,
							A2(
			...
			return A2(
				...
				function (baseUri) {
					return elm$json$Json$Decode$succeed(
						{baseUri: baseUri, initialTime: initialTime});
				},
				A2(elm$json$Json$Decode$field, 'baseUri', elm$json$Json$Decode$string));
		},
		A2(elm$json$Json$Decode$field, 'initialTime', elm$json$Json$Decode$int)))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"Noop":[],"CalendarDateSelected":["String.String"]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));